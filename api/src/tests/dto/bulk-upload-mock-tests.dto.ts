...
export class BulkUploadMockTestItemDto {
  ...
  @ApiPropertyOptional({ description: 'Question IDs from question bank to attach to this mock test', type: [String] })
  @IsOptional()
  @IsArray()
  @IsUUID('4', { each: true })
  questionIds?: string[];
...
export class BulkUploadMockTestsDto {
  @ApiProperty({
    description: 'Array of mock tests to create (each may include questionIds to attach)',
